...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SMTImageTitleDescCell *cell = (SMTImageTitleDescCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[SMTImageTitleDescCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        __weak typeof(self)weakSelf = self;
        cell.itemBlock = ^(SMTImageTitleDescCell *cell ,NSInteger itemTag){
...
- (void)clickItemInCell:(SMTImageTitleDescCell *)cell itemTag:(NSInteger)itemTag {
